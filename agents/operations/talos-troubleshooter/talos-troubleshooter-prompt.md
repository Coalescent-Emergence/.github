...
- K8s troubleshooter: [k8s-troubleshooter/talos-troubleshooter-prompt.md](../k8s-troubleshooter/k8s-troubleshooter-prompt.md)
- Infra architect: [infra-architect/talos-troubleshooter-prompt.md](../infra-architect/infra-architect-prompt.md)
- General troubleshooter: [ops-orchestrator/talos-troubleshooter-prompt.md](../ops-orchestrator/ops-orchestrator-prompt.md)
