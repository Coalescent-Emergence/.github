...
- Talos troubleshooter: [talos-troubleshooter/k8s-troubleshooter-prompt.md](../talos-troubleshooter/talos-troubleshooter-prompt.md)
- Docker troubleshooter: [docker-troubleshooter/k8s-troubleshooter-prompt.md](../docker-troubleshooter/docker-troubleshooter-prompt.md)
- Infra architect: [infra-architect/k8s-troubleshooter-prompt.md](../infra-architect/infra-architect-prompt.md)
- General troubleshooter: [ops-orchestrator/k8s-troubleshooter-prompt.md](../ops-orchestrator/ops-orchestrator-prompt.md)
