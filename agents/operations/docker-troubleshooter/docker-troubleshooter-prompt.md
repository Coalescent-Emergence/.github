...
- K8s troubleshooter: [k8s-troubleshooter/docker-troubleshooter-prompt.md](../k8s-troubleshooter/k8s-troubleshooter-prompt.md)
- Talos troubleshooter: [talos-troubleshooter/docker-troubleshooter-prompt.md](../talos-troubleshooter/talos-troubleshooter-prompt.md)
- Infra architect: [infra-architect/docker-troubleshooter-prompt.md](../infra-architect/infra-architect-prompt.md)
- General troubleshooter: [ops-orchestrator/docker-troubleshooter-prompt.md](../ops-orchestrator/ops-orchestrator-prompt.md)
