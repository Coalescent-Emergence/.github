...
## Files
- [refactor-auditor-prompt.md](./refactor-auditor-prompt.md) - System prompt and refactor analysis templates
- [refactor-auditor-schema.json](./refactor-auditor-schema.json) - JSON schema for risk assessments
