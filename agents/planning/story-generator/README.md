...
- Links to [Technical Decomposer](../technical-decomposer/) for further task breakdown

## Files
- [story-generator-prompt.md](./story-generator-prompt.md) - System prompt and story generation templates
- [story-generator-schema.json](./story-generator-schema.json) - JSON schema for story outputs
