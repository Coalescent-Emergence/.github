...
- Coordinates with [Story Generator](../story-generator/) output

## Files
- [technical-decomposer-prompt.md](./technical-decomposer-prompt.md) - System prompt and decomposition templates
- [technical-decomposer-schema.json](./technical-decomposer-schema.json) - JSON schema for task outputs
