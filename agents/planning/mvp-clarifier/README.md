...
- Can trigger [story-generator agent](../story-generator/) via `ai:generate` label on generated stories

## Files
- [mvp-clarifier-prompt.md](./mvp-clarifier-prompt.md) - System prompt and user prompt templates
- [mvp-clarifier-schema.json](./mvp-clarifier-schema.json) - JSON schema for input/output validation
