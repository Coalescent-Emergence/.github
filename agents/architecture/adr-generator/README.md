...
* [Architecture: Layered Service Model](../../../docs/decisions/0003-layered-service-architecture.md) - Token sharing may be needed if services authenticate directly
...
## Files
- [adr-generator-prompt.md](./adr-generator-prompt.md) - System prompt and MADR generation templates
- [adr-generator-schema.json](./adr-generator-schema.json) - JSON schema for ADR draft outputs
