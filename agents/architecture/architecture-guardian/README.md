...
```markdown
### 🏛️ Architecture Guardian Review

**Status**: ⚠️ Potential ADR violations detected

#### Violations

##### ⚠️ Warning: JWT Signing Algorithm Change
- **ADR**: [0004-jwt-signing-algorithm.md](# "example: Kerrigan ADR path")
...
- **Line**: [internal/auth/jwt.go:45](# "example: source path")
...
✅ **ADR 0001**: Repository structure - Changes in `internal/auth/` follow established package layout

✅ **ADR 0002**: Go as backend language - Using Go standard patterns
...
## Files
- [architecture-guardian-prompt.md](./architecture-guardian-prompt.md) - System prompt and ADR analysis templates
- [architecture-guardian-schema.json](./architecture-guardian-schema.json) - JSON schema for violation outputs
