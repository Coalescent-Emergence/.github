...
- Can trigger [ADR Generator](../adr-generator/) when `adr_needed: true`
...
## Files
- [c4-architect-prompt.md](./c4-architect-prompt.md) - System prompt and C4 level templates
- [c4-architect-schema.json](./c4-architect-schema.json) - JSON schema for outputs
